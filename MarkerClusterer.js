...
(function(){
    ...
    var MarkerClusterer =  
        ...
        BMapLib.MarkerClusterer = function(map, options){
			...
			this._formatter = opts["formatter"] || null;
			if(this._formatter) this._minClusterSize = 1;
    ...
    function Cluster(markerClusterer){
		...
		if(markerClusterer._formatter) this._formatter = markerClusterer._formatter;
		this._interval = markerClusterer._interval || 10;
        this._center = null;//落脚位置
        this._markers = [];//这个Cluster中所包含的markers
        this._gridBounds = null;//以中心点为准，向四边扩大gridSize个像素的范围，也即网格范围
        this._isReal = false; //真的是个聚合
     
        this._clusterMarker = new BMapLib.TextIconOverlay(this._center, this._markers.length, {"styles":this._markerClusterer.getStyles(), "interval": this._interval});
    ...
    Cluster.prototype.updateClusterMarker = function () {
		...
		if(this._formatter) {
			this._clusterMarker.setText(this._formatter(this._markers));
		} else {
